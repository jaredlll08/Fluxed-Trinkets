...
public class RecipeHandler {
	...
	private static void registerRecipes() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ETItems.beltStep), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.jumpCircuit), new ItemStack(ETItems.beltEmpty));
		GameRegistry.addShapelessRecipe(new ItemStack(ETItems.beltFire), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.jumpCircuit), new ItemStack(ETItems.beltEmpty));
		GameRegistry.addShapelessRecipe(new ItemStack(ETItems.beltIce), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.basicBattery), new ItemStack(ETItems.speedCircuit), new ItemStack(ETItems.beltEmpty));
