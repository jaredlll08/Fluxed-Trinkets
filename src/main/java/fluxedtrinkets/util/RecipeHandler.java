...
public class RecipeHandler {
	...
	private static void registerRecipes() {
		...
		// GameRegistry.addRecipe(new ItemStack(ETItems.circuit), new Object[] {
		// "ege", "gbg", "ege", 'e', new ItemStack(Items.emerald), 'g', new
		// ItemStack(Items.dye, 1, 2), 'b', new ItemStack(Items.book) });
